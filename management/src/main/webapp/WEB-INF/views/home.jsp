					...
					<div class="col-md-12">
						<div class="flexslider">
							<div class="flex-caption">
								<!-- Left column -->
								<div class="col-l">
									<p style="text-indent:2em;">Exam是网络考试系统, 它可以稳定、顺畅的运行在Linux平台上。您可以通过它快捷方便的创建试题和题库，发布试卷，组织考试，系统自动批改。高度的可配置性和灵活性使得它可以被应用于很多领域。</p>
								...
								<div class="col-r">
									...
									<p style="text-indent:2em;">软件有固定的开发团队提供技术支持。如果您对软件有任何反馈和建议，请联系我们!</p>
